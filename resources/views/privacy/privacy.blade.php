...
@section('content')
    <div class="container pt-5">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to nlivres.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to nlivres, accessible from <a href="https://nlivres.com"
                        rel="external nofollow noopener" target="_blank">https://nlivres.com</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>
                <p>By email: support@nlivres.com</p>
            </li>
            <li>
                <p>By visiting this page on our website: <a href="https://nlivres.com/contact"
                        rel="external nofollow noopener" target="_blank">https://nlivres.com/contact</a></p>
            </li>
        </ul>
    </div>
@endsection
